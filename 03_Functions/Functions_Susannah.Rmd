...
```{r}
makeplot <- function(file, plot_code, width=500, height=500) {
...
makeplot("~/Documents/classes/UBCadv-r/03_Functions/Functions_Susannah_plot.png", borked)
makeplot("~/Documents/classes/UBCadv-r/03_Functions/Functions_Susannah_plot.png", simpleplot)
```
