...
*1) Integer, character, raw, double, logical, complex are the 6 types of atomic vectors. Lists are recursive, but atomic vectors are flat. Lists are heterogenous and atomic vectors are homogenous.
...
*3) You can have a data frame with 0 rows, and with 0 columns.
